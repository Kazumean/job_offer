    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title" placeholder="例: Laravel開発中級者" value="{{ old('title') }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location" placeholder="例: 神奈川県鎌倉市（リモート勤務あり） など" value="{{ old('location') }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags" placeholder="例: Laravel, バックエンド, Postgres など" value="{{ old('tags') }}"/>
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10" placeholder="具体的な業務内容やご要望、給与等を記入してください。">{{ old('description') }}</textarea>
