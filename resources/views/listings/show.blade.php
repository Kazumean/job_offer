...
<a href="/" class="inline-block text-black ml-4 mb-4"><i class="fa-solid fa-arrow-left"></i> 戻る</a>
            <div class="mx-4">
                <x-card class="p-10">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <div>
                            <h3 class="text-3xl font-bold mb-4">お仕事内容詳細</h3>
                ...
                {{-- <x-card class="mt-4 p-2 flex space-x-6">
                    <a href="/listings/{{ $listing->id }}/edit">
                        <i class="fa-solid fa-pencil"></i> 編集する
                    </a>

                    <form method="POST" action="/listings/{{ $listing->id }}">
                        @csrf
                        @method('DELETE')
                        <button class="text-red-500"><i class="fa-solid fa-trash"></i>削除する</button>
                    </form>
                </x-card> --}}
            </div>
